document.addEventListener('DOMContentLoaded', () => {
    ...
    function movePlayerWithAnimation(player, spaces) {
      ...
      // Animation function to move one square at a time
      function moveOneStep() {
        if (stepCount < spaces && currentPosition < 100) {
          currentPosition++;
          ...
          // Check for snakes and ladders after movement is complete
          checkSnakesAndLadders(player, currentPosition);
        }
      }
